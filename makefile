...
local-out-zip-file := MIUI8_crackling.zip
...
# All apks from MIUI
local-miui-removed-apps := BugReport GameCenter FM Mipay MiuiCompass XiaomiVip MiGameCenterSDKService MiLivetalk MiuiVoip SogouInput SystemAdSolution VoiceAssist XMPass YellowPage MiuiScanner

local-miui-modified-apps := InCallUI TeleService SecurityCenter MiuiHome miuisystem

# Config density for co-developers to use the aaps with HDPI or XHDPI resource,
# Default configrations are HDPI for ics branch and XHDPI for jellybean branch
local-density := XHDPI

PORT_PRODUCT := crackling
